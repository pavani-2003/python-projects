...
kb = {
    ...
    "who are you?": "My name is ""pavv.."",I am a simple rule-based chatbot here to assist you.",
    ...
    "who created you?": "I was created by a developer called pavani kankanampati, who wanted to build a helpful chatbot.",
    ...
    "is it raining today?": "I can't tell, but a weather app might help you find out!",
    ...
    "what's your favorite color?": "I don't have a favorite color,but my creator's is yellow,but I think all colors are wonderful!",
    ...
    "do you have a name?": "I do have a name,that is pavv..",
